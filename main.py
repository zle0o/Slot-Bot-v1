...
# Made by zle0o (discord.gg/leosservice)
...
bot = commands.Bot(
    ...
    activity=discord.Activity(
        type=discord.ActivityType.watching, name="Leo's Services"
    ),
    guild = discord.Object(id=1282727370406756534) # Change it with your guild id right click on your server and copy the server id and paste it instead of 1282727370406756534
)
...
async def delete(ctx):
    if discord.utils.get(ctx.guild.roles, id=1282727718601101396) in ctx.author.roles:
        try:
...
async def add(ctx, member: discord.Member):
    role = ctx.guild.get_role(1312751710204203061)
...
async def create(ctx, member: discord.Member = None, yoyo: int = None, cx=None, ping_count: int = 0, category: str = "category1", *, x=None):
    ...
    if category.lower() == 'category1':
        category_id = 1312752934076809328  # Category 1 ID
    else:
        category_id = 1312753125005856818  # Category 2 ID
...
"""
    ...
    embed.set_image(url="https://cdn.discordapp.com/attachments/1305118843928182824/1313960230996017313/standard.gif?ex=67520853&is=6750b6d3&hm=07f6942fd63154de603708cf1aa6105f8dc2f9d8895bc3e9e11bf7a9a161846c&")
